  ...
  return (
    <section id="testimonials" className="py-16 px-4 max-w-7xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate, quidem.</p>
      </div>
        ...
        >
          {testimonials.map((testimonial, index) => (
            <SwiperSlide key={index} className="py-4">
              <div className="h-full text-center bg-white p-6 rounded-lg shadow-md flex flex-col">
                ...
                {/* teks biar isi sisa ruang */}
                <p className="text-gray-600 flex-1">{testimonial.text}</p>
              </div>
            </SwiperSlide>
          ))}
        </Swiper>
