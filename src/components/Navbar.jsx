...
const Navbar = () => {
  ...
  return (
    ...
    whileInView="show"
    viewport={{once:true}}
    className="fixed top-0 right-0 left-0 bg-white backdrop-blur-sm z-50 border-b shadow-sm border-gray-100">
      <div className="w-full  flex items-center container justify-between mx-auto px-4 sm:px-6 lg:px-8 md:h-20 h-16">
        {/* logo */}
        ...
        >
          <a href="#newspaper">Get In Touch</a>
        </button>
      </div>
